...
(0, _nornj.registerFilter)({
  clickBtn: function clickBtn(fn, type) {
    ...
    switch (type) {
      case 'first':
        return function () {
          var pageIndex = _this.data[0].pageIndex;
      ...
      case 'last':
        return function () {
          var _data$2 = _this.data[0];
          var pageIndex = _data$2.pageIndex;
          var pageCount = _data$2.pageCount;
